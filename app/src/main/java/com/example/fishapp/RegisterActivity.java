            ...
            public void onClick(View view) {
                ...
                fAuth.createUserWithEmailAndPassword(strREmail,strRPassword).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        Intent userDetails = new Intent(getApplicationContext(),OTPActivity.class);
                        userDetails.putExtra("phone","+91"+strRPhone);
                        userDetails.putExtra("username",strRUsername);
                        userDetails.putExtra("email",strREmail);
                        userDetails.putExtra("password",strRPassword);
